    ...
    <body class="antialiased">
        <div class="error-page">
            <div class="max-w-md mx-auto px-6 text-center">
                <p class="text-6xl font-bold text-zinc-500">404</p>
                <h1 class="mt-4 text-xl font-semibold text-zinc-100">Página no encontrada</h1>
                <p class="mt-2 text-sm text-zinc-400">La página que buscas no existe o fue movida.</p>
                <p class="mt-6">
