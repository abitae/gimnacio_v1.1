<div class="space-y-4">
    ...
    <div class="flex gap-2 items-center flex-wrap">
        <x-crm.day-range-toggle wire-model="renovacionDays" :current="$renovacionDays"
            label-text="Membresías que vencen en:"
            :options="['7' => '7 días', '3' => '3 días', '1' => '1 día']" />
        @can('crm.crear')
    ...
    <div class="rounded-lg border border-zinc-200 dark:border-zinc-700 overflow-hidden">
        <table class="w-full text-sm">
            ...
            <tbody class="divide-y divide-zinc-200 dark:divide-zinc-700">
                ...
                @empty
                <tr><td colspan="3"><x-empty-state message="No hay membresías por vencer en este período" /></td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
    ...
    @if($tab === 'reactivacion')
    <div class="flex gap-2 items-center flex-wrap">
        <x-crm.day-range-toggle wire-model="reactivacionDays" :current="$reactivacionDays"
            label-text="Membresías vencidas hace:"
            :options="['15' => '15 días', '30' => '30 días', '60' => '60 días']" />
        @can('crm.crear')
    ...
    <div class="rounded-lg border border-zinc-200 dark:border-zinc-700 overflow-hidden">
        <table class="w-full text-sm">
            ...
            <tbody class="divide-y divide-zinc-200 dark:divide-zinc-700">
                ...
                @empty
                <tr><td colspan="3"><x-empty-state message="No hay registros para este período" /></td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
