...
<flux:error name="formData.precio_base" />
                ...
                <p class="rounded-lg border border-dashed border-zinc-200 bg-zinc-50 p-2 text-[11px] text-zinc-600 dark:border-zinc-600 dark:bg-zinc-900/40 dark:text-zinc-400">
                    El pago en cuotas se define al registrar la matrícula de cada cliente (número de cuotas, frecuencia e inicial), no en el plan de membresía.
                </p>
