                ...
                <table class="w-full min-w-full text-sm">
                                        ...
                                        @if ($celda)
                                            ...
                                            @if (! empty($celda['cantidad']))
                                                <button type="button"
                                                    ...
                                                    class="ml-0.5 text-indigo-600 hover:underline dark:text-indigo-400"
                                ...
                                <td class="px-4 py-2 text-right text-xs font-semibold">
                                    ...
                                    @if (! empty($matriz['cantidades_tipo'][$tipo]))
                                        <button type="button"
                                            ...
                                            class="ml-0.5 font-normal text-indigo-600 hover:underline dark:text-indigo-400"
                    ...
                    <tfoot class="bg-zinc-50 dark:bg-zinc-950/40">
                        <tr>
                            ...
                            @endforeach
                            <td class="px-4 py-2 text-right text-xs font-bold text-emerald-700 dark:text-emerald-400">
                    ...
                    <table class="w-full text-sm">
                        ...
                        <tbody class="divide-y divide-zinc-200 dark:divide-zinc-700">
                            @forelse ($movimientosMatrizDetalle as $movimiento)
                                <tr class="hover:bg-zinc-50 dark:hover:bg-zinc-800/40">
                                    <td class="whitespace-nowrap px-3 py-2 text-xs">{{ $movimiento['fecha']?->format('d/m/Y H:i') ?? '-' }}</td>
                                    <td class="px-3 py-2 text-xs">#{{ $movimiento['caja_id'] ?? ($cajaActiva->id ?? '-') }}</td>
                                    ...
                                    <td class="whitespace-nowrap px-3 py-2 text-right text-xs font-semibold text-emerald-600 dark:text-emerald-400">
